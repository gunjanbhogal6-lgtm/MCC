...
files = [
    ...
    "../frontend/src/pages/solutions.astro", 
    "../frontend/src/pages/resources.astro", 
    "../frontend/src/pages/about.astro", 
    "../frontend/src/pages/wholesale-voice.astro",
    "../frontend/src/pages/virtual-phone-number.astro", 
    "../frontend/src/pages/international-top-up.astro", 
    "../frontend/src/pages/sms-service.astro", 
    "../frontend/src/pages/cc-routes.astro"
]
